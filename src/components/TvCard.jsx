...
const TvCard = ({
  ...
  // Shifted data parsing logic UP so the payload variable can securely access them
      ...
      {isModalOpen && createPortal(
        ...
        >
          ...
          >
            ...
            <p>Enter a name for your playlist. This TV show will be added automatically.</p>
