      ...
      <div className="error-page fade-in">
        ...
        <div className="w-full flex flex-col justify-center items-center animate-slide-up">
          <img
            ...
            alt=""
          />
          <p className='text-desciption font-bold text-xs sm:text-base'>! 404 ERROR !</p>
          <p className="text-desciption font-bold text-xs sm:text-base">
            The requested URL was not found on the server.
          </p>
          <h2
            className="cursor-pointer text-base mt-5 bg-violet-500 p-2 rounded-lg hover:bg-violet-400 hover:text-lg transition3s"
            onClick={handleClick}
          >
            Back To Home
          </h2>
