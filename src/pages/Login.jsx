    ...
    <div className="min-h-screen bg-brand-bg flex items-center justify-center px-4 relative">
      ...
      <div className="bg-surface backdrop-blur-md border border-brand-text/10 p-8 lg:mt-[95px] rounded-2xl w-full max-w-md shadow-2xl z-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="bg-brand-bg text-brand-text rounded-lg px-3 py-2 border border-muted/30 focus:outline-none focus:border-accent transition3s"
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-accent hover:bg-accent-hover text-white font-medium py-2 rounded-lg transition3s mt-2 disabled:opacity-50 cursor-pointer"
          >
        ...
        <div className="flex items-center my-5">
          <div className="flex-1 border-t border-muted/20"></div>
          <span className="px-3 text-xs font-semibold text-muted uppercase">Or</span>
          <div className="flex-1 border-t border-muted/20"></div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-brand-bg hover:bg-muted/10 text-brand-text border border-muted/20 rounded-lg py-2 font-medium transition3s disabled:opacity-50 cursor-pointer"
        >
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="text-sm text-muted hover:text-accent transition3s cursor-pointer"
          >
