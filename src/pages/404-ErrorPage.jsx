  ...
  return (
    ...
    <div className="error-page fade-in">
        ...
        <div className='w-full flex flex-col justify-center items-center animate-slide-up'>
            <img className='w-[70vw] sm:w-[20vw] mb-5 ' src="404-Error.png" alt="" />
        <p className='text-desciption text-xs sm:text-base'>The requested URL was not found on the server.</p>
        <p className='text-desciption text-xs sm:text-base'>If you entered the URL manually please check your spelling and try again.</p>
        <h2 className='cursor-pointer text-base mt-5 bg-violet-500 p-2 rounded-lg hover:bg-violet-400 hover:text-lg transition3s' onClick={handleClick}>Back To Home</h2>
        </div>
        <footer className=" p-5 fixed bottom-0 left-1/2 transform -translate-x-1/2 min-w-lg">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-gray-100 font-bold text-xs sm:text-base">
                © 2025 EZ Movies - By{" "}
                <a
